...
<div class="signup-form">
	...
	<div class="text-center">Bạn co săn san để tạo một tai khoản? <a href="{{route('Auth.register')}}">Đăng Ký</a></div>
	<div class="text-center">Về <a href="{{route('home')}}">Trang Chủ</a></div>
</div>
</body>
</html>
