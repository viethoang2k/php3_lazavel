...
<div class="signup-form">
    <form action="" method="post">
		<h2>Đăng Ký </h2>
		<p class="hint-text">Tạo tài khoản của bạn. Nó miễn phí và chỉ mất một phút.</p>
		@foreach($errs as $e)
            <p style="color: red">
            @if(is_array($e))
                {{implode('<br>',$e)}}
	...
	<div class="text-center">Bạn co săn san để tạo một tai khoản? <a href="{{route('Auth.Login')}}">Đăng Nhập</a></div>
</div>
</body>
</html>
